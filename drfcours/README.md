...
```
git@github.com:Mery-debug/drfcourse.git
```
...
## Telegram Интеграция
### Как подключить:
1. Найдите нашего бота: `t.me/tracker_of_habits_remember_bot`
...
## Тестирование:
Проект покрыт тестами на 76%, приложение авторизации пользователей протестировано косвенно через тестирование приложения
привычек.
